...
{
    // echo"Hello";
        $sql="TRUNCATE TABLE `student_messages`";
        mysqli_query($connect,$sql);
    
}
if($_SERVER['REQUEST_METHOD']=='POST')
{
        $dummy='Sorry cannot get what u said';
        $message=strtolower($_POST['query']);
        $time=$_POST['time'];
        $sql="SELECT * FROM `interaction` where `interaction`.`questions`='$message'";
        $res=mysqli_query($connect,$sql);
        if(mysqli_num_rows($res)==0)
        {
                $insert1="INSERT INTO `student_messages`(`student_message`,`bot_message`,`time`) VALUES('$message','$dummy','$time')";
            ...
            else
            {
                ...
                $insert2="INSERT INTO `student_messages`(`student_message`,`bot_message`,`time`) VALUES('$message','$bot_message','$time')";
        ...
        // $resolve=mysqli_fetch_assoc($res);
        // $bot_message=$resolve['']
...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Nunito&family=Work+Sans:wght@200&display=swap"
        rel="stylesheet">
    <link rel="stylesheet" href="http://localhost/PHP_Files/chat-bot_system/chat-bot.css">
    <style>
    #delete_msg {
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                <form action="//localhost/PHP_Files/chat-bot_system/chat_bot.php" method="get">
                        <button  id="delete_msg" name="close">Close</button>
                </form>
</li>
            </ul>
        </nav>
    ...
    <div class="main-container">
        <p class="logo1">Student Chat-bot System</p>

<?php

        $display_sql="SELECT * FROM `student_messages`";
        ...
        if(mysqli_num_rows($disply_result)!=0)
        {
            ...
            ?>
        <form class="text-input" action="//localhost/PHP_Files/chat-bot_system/chat_bot.php" method="post">
